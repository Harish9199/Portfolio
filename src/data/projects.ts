...
export const projects: Project[] = [
  {
    ...
    links: [{ type: "github", url: "https://github.com/Harish9199", label: "Source Code" }],
    featured: true,
    category: "AI/ML",
  },
  {
  ...
  },
  {
    ...
    tagline: "Convert PRDs into structured Claude CLI-based project architectures",
    description:
      "An interactive web application to convert Product Requirement Documents (PRDs) into structured Claude CLI-based project architectures with AI-powered scaffolding.",
    longDescription:
      "Developed an interactive web application to convert Product Requirement Documents (PRDs) into structured Claude CLI-based project architectures. Implemented AI-powered scaffolding including agent configurations, MCP server setups, and documentation planning. Integrated Mermaid.js for dynamic architecture diagrams and built a single-page UI with file upload/export and developer-focused features.",
    problem:
      "Translating PRDs into well-structured project architectures with proper agent configurations and server setups is manual, time-consuming, and error-prone.",
    solution:
      "Built an interactive web app that uses AI to automatically scaffold project architectures from PRDs, complete with agent configs, MCP server setups, dynamic Mermaid.js diagrams, and file upload/export capabilities.",
    impact:
      "Streamlined the process of converting PRDs into actionable project architectures, enabling faster project bootstrapping with consistent structure and documentation.",
    technologies: ["React", "Mermaid.js", "Claude API", "JavaScript", "CSS-in-JS"],
    metrics: [
      { label: "Input", value: "PRD Upload" },
      { label: "Output", value: "Architecture" },
      { label: "Diagrams", value: "Dynamic" },
    ],
    links: [{ type: "github", url: "https://github.com/Harish9199", label: "Source Code" }],
    featured: true,
    category: "AI/ML",
